...
const Edit = () => {
  ...
  const deleteProject = (id) => {
    const copyProjects = data.projects.filter((project) => project.id !== id); // Create a new array directly
    setData({ ...data, projects: copyProjects });
  };
  ...
  const deleteService = (id) => {
    const copyServices = data.services.filter((service) => service.id !== id); // Create a new array directly
    setData({ ...data, services: copyServices });
  };
  ...
  const deleteSocials = (id) => {
    const copySocials = data.socials.filter((social) => social.id !== id); // Create a new array directly
    setData({ ...data, socials: copySocials });
  };
